...
class LLMAgent:
    ...
    def _ask_llm_for_plan(self, query: str) -> List[Dict]:
        ...
        - **filesystem**: For reading, writing, listing and deleting files in a sandbox folder. Input MUST be a JSON object: {{"operation": "read|write|list|delete", "path": "relative/path.txt", "content": "text, only for write"}}.
